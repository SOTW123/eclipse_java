...
import tic_tac_toe.HomeScreen;

public class AI_ImpossibleMode extends JFrame implements ActionListener{
	...
	ArrayList<Integer> options = new ArrayList<>(List.of(1,2,3,4,5,6,7,8,9));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(counter % 2 == 0) {
			if(e.getSource()==box1) {
				...
				counter++;
				if(box1.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(1));
				}
				if(box2.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(2));
				}
				if(box3.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(3));
				}
				if(box4.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(4));
				}
				if(box5.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(5));
				}
				if(box6.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(6));
				}
				if(box7.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(7));
				}
				if(box8.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(8));
				}
				if(box9.getText().equals("X") || box1.getText().equals("O")) {
					options.remove(Integer.valueOf(9));
				}
				int bot = rand.nextInt(options.get(0), options.get(options.size()-1));
				switch(bot) {
				case 1:
						one = true;
						box1.setText("O");
